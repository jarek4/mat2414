...
class Report {
  ...
  final int businessTerritoryWitnessingHours;

  final int businessTerritoryWitnessingQuantity;

  final int eveningWitnessingHours;

  final int eveningWitnessingQuantity;

  final int hours;

  final int informalWitnessingHours;

  final int informalWitnessingQuantity;
  final bool isClosed;
  ...
  final int publicWitnessingHours;

  final int publicWitnessingQuantity;
  ...
  final int sundayWitnessingHours;

  final int sundayWitnessingQuantity;
  final String? uid;

  final int withFieldServiceGroupWitnessingHours;

  final int withFieldServiceGroupWitnessingQuantity;
