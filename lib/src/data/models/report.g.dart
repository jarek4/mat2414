...
void _reportSerialize(
  ...
  writer.writeLong(offsets[0], object.bibleStudies);
  writer.writeLong(offsets[1], object.businessTerritoryWitnessingHours);
  writer.writeLong(offsets[2], object.businessTerritoryWitnessingQuantity);
  writer.writeDateTime(offsets[3], object.createdAt);
  writer.writeLong(offsets[4], object.eveningWitnessingHours);
  writer.writeLong(offsets[5], object.eveningWitnessingQuantity);
  writer.writeLong(offsets[6], object.hashCode);
  writer.writeLong(offsets[7], object.hours);
  writer.writeLong(offsets[8], object.informalWitnessingHours);
  writer.writeLong(offsets[9], object.informalWitnessingQuantity);
  writer.writeBool(offsets[10], object.isClosed);
  writer.writeDateTime(offsets[11], object.lastModified);
  writer.writeLong(offsets[12], object.minutes);
  writer.writeLong(offsets[13], object.month);
  writer.writeLong(offsets[14], object.placements);
  writer.writeLong(offsets[15], object.publicWitnessingHours);
  writer.writeLong(offsets[16], object.publicWitnessingQuantity);
  writer.writeString(offsets[17], object.remarks);
  writer.writeLong(offsets[18], object.returnVisits);
  writer.writeString(offsets[19], object.serviceYear);
  writer.writeLong(offsets[20], object.specialHours);
  writer.writeString(offsets[21], object.specialHoursDescription);
  writer.writeLong(offsets[22], object.sundayWitnessingHours);
  writer.writeLong(offsets[23], object.sundayWitnessingQuantity);
  writer.writeString(offsets[24], object.uid);
  writer.writeLong(offsets[25], object.videos);
  writer.writeLong(offsets[26], object.withFieldServiceGroupWitnessingHours);
  writer.writeLong(offsets[27], object.withFieldServiceGroupWitnessingQuantity);
...
Report _reportDeserialize(
  ...
  final object = Report(
    bibleStudies: reader.readLongOrNull(offsets[0]) ?? 0,
    businessTerritoryWitnessingHours: reader.readLongOrNull(offsets[1]) ?? 0,
    businessTerritoryWitnessingQuantity: reader.readLongOrNull(offsets[2]) ?? 0,
    createdAt: reader.readDateTime(offsets[3]),
    eveningWitnessingHours: reader.readLongOrNull(offsets[4]) ?? 0,
    eveningWitnessingQuantity: reader.readLongOrNull(offsets[5]) ?? 0,
    hours: reader.readLongOrNull(offsets[7]) ?? 0,
    id: id,
    informalWitnessingHours: reader.readLongOrNull(offsets[8]) ?? 0,
    informalWitnessingQuantity: reader.readLongOrNull(offsets[9]) ?? 0,
    isClosed: reader.readBoolOrNull(offsets[10]) ?? false,
    lastModified: reader.readDateTime(offsets[11]),
    minutes: reader.readLongOrNull(offsets[12]) ?? 0,
    month: reader.readLong(offsets[13]),
    placements: reader.readLongOrNull(offsets[14]) ?? 0,
    publicWitnessingHours: reader.readLongOrNull(offsets[15]) ?? 0,
    publicWitnessingQuantity: reader.readLongOrNull(offsets[16]) ?? 0,
    remarks: reader.readStringOrNull(offsets[17]) ?? '',
    returnVisits: reader.readLongOrNull(offsets[18]) ?? 0,
    serviceYear: reader.readString(offsets[19]),
    specialHours: reader.readLongOrNull(offsets[20]) ?? 0,
    specialHoursDescription: reader.readStringOrNull(offsets[21]) ?? '',
    sundayWitnessingHours: reader.readLongOrNull(offsets[22]) ?? 0,
    sundayWitnessingQuantity: reader.readLongOrNull(offsets[23]) ?? 0,
    uid: reader.readStringOrNull(offsets[24]),
    videos: reader.readLongOrNull(offsets[25]) ?? 0,
    withFieldServiceGroupWitnessingHours:
        reader.readLongOrNull(offsets[26]) ?? 0,
    withFieldServiceGroupWitnessingQuantity:
        reader.readLongOrNull(offsets[27]) ?? 0,
