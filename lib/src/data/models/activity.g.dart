...
void _activitySerialize(
  ...
  writer.writeLong(offsets[4], object.hours);
...
Activity _activityDeserialize(
  ...
  final object = Activity(
    ...
    day: reader.readLong(offsets[2]),
    hours: reader.readLongOrNull(offsets[4]) ?? 0,
    id: id,
